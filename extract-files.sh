...
TWRP_QSEECOMD="$AEX_ROOT"/vendor/"$VENDOR"/"$DEVICE"/proprietary/recovery/root/sbin/qseecomd
TWRP_GATEKEEPER="$AEX_ROOT"/vendor/"$VENDOR"/"$DEVICE"/proprietary/recovery/root/sbin/android.hardware.gatekeeper@1.0-service
TWRP_KEYMASTER="$AEX_ROOT"/vendor/"$VENDOR"/"$DEVICE"/proprietary/recovery/root/sbin/android.hardware.keymaster@3.0-service
GOODIX="$AEX_ROOT"/vendor/"$VENDOR"/"$DEVICE"/proprietary/vendor/lib64/libgf_ca.so
...
BLOB_ROOT="$AEX_ROOT"/vendor/"$VENDOR"/"$DEVICE"/proprietary
